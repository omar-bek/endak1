        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="voice_note_enabled" name="voice_note_enabled" value="1"
                            ...
                            <small class="form-text text-muted d-block">السماح للمستخدمين بتسجيل صوتي في هذا القسم</small>
                        </div>
                    </div>
