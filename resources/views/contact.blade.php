                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">{{ \App\Helpers\WhatsAppHelper::getWhatsAppNumber() }}</small>
                                </div>
                            </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        <div class="accordion-item">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    يمكنك التسجيل بسهولة من خلال النقر على زر "التسجيل" في أعلى الصفحة وملء النموذج
                                    بالمعلومات المطلوبة.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    بعد تسجيل الدخول، يمكنك الذهاب إلى لوحة التحكم وإضافة خدمة جديدة من خلال النقر على
                                    "إضافة خدمة".
                                </div>
                            </div>
                        </div>
