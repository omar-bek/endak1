...
<section class="hero-area position-relative text-white overflow-hidden">
    ...
    <svg viewBox="0 0 1440 200" preserveAspectRatio="none"
        class="position-absolute bottom-0 start-0 w-100 hero-wave">
        <defs>
        ...
        <path id="wavePath"
            ...
            fill="url(#waveGradient)" filter="url(#shadow)" opacity="0.95">
            <animate 
                attributeName="d" 
                dur="6s" 
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-6 col-md-6 col-lg-3 mb-4 fade-card">
                <a href="{{ $category->hasChildren() ? route('categories.subcategories', $category->slug) : route('services.request', $category->id) }}" class="card-link">
