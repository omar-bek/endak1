                            ...
                            @if($profile && $profile->rating)
                                <div class="mb-2">
                                    ...
                                    @if($profile->completed_services)
                                        <span class="text-muted ms-2">• {{ $profile->completed_services }} خدمة مكتملة</span>
                                    @endif
                                </div>
                            @endif
                            ...
                            @foreach($services as $service)
                                <div class="col-md-6 mb-3">
                                    <div class="card border-warning">
                                        <div class="card-body">
                                            <h6 class="card-title">
                                                <a href="{{ route('services.show', $service->slug) }}" class="text-dark">
                                                    {{ $service->title }}
                                                </a>
                                            </h6>
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-primary">{{ isset($activeCategories) ? $activeCategories->count() : 0 }}</h4>
                        ...
                        <div class="col-6 mb-3">
                            <div class="border rounded p-3">
                                <h4 class="text-warning">{{ number_format($profile ? ($profile->rating ?? 0) : 0, 1) }}</h4>
