...
<div class="container mt-4">
    ...
    <div class="alert alert-info text-center">
        ...
        @if($selectedSubCategory)
            <br><small class="text-muted">القسم الفرعي: {{ app()->getLocale() == 'ar' ? $selectedSubCategory->name_ar : $selectedSubCategory->name_en }}</small>
        @elseif($hasSubCategories)
            <br><small class="text-warning">⚠️ يجب اختيار قسم فرعي لطلب الخدمة</small>
        @endif
    </div>
</div>
<style>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    @if($category->image)
                        <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" class="img-fluid mb-3" style="max-width: 200px; border-radius: 10px;">
                    @endif
                    ...
                    @if($selectedSubCategory)
                        <div class="alert alert-info mt-3">
                            ...
                            <strong>القسم الفرعي المحدد:</strong> {{ app()->getLocale() == 'ar' ? $selectedSubCategory->name_ar : $selectedSubCategory->name_en }}
                            @if($selectedSubCategory->description_ar || $selectedSubCategory->description_en)
                                <br><small class="text-muted">{{ app()->getLocale() == 'ar' ? $selectedSubCategory->description_ar : $selectedSubCategory->description_en }}</small>
                            @endif
                        </div>
                    @endif
                </div>
